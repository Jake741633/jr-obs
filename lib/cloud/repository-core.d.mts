...
export function hasReplayableSyncQueueItems(queue: Array<Pick<QueueMutation, "state">>): boolean;
...
export function sanitizeQueuedFieldMutationProjection<T extends {
  table?: string;
  collectionKey?: string;
  role?: string;
  organisationId?: string;
  ...
  payload?: unknown;
  sentAt?: string;
}>(change: T, now?: number): T | undefined;
