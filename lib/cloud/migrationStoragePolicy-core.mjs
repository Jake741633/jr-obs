...
const ELECTRICIAN_NETWORK_ONLY_BACKUP_KEYS = new Set([
  "jr-os-job-documents",
]);
...
export function accountBackupStorageKeyAllowed(storageKey, role) {
  return !(
    (role === "customer" && CUSTOMER_NETWORK_ONLY_BACKUP_KEYS.has(storageKey))
    || (role === "electrician" && ELECTRICIAN_NETWORK_ONLY_BACKUP_KEYS.has(storageKey))
  );
}
