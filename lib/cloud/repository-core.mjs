...
export function retainProjectionMutationConflict(queue, change) {
  return coalesceQueue(queue, {
    ...change,
    state: "Conflict",
    error: "This projected record requires the secure field mutation service before it can be changed.",
  });
}
