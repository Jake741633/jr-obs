...
export type EntityBase = Customer | Builder | CustomerProfile | CustomerInteraction | AiReminder | AiLearningMemory | Job | SalesLead | LeadActivity | JobTimelineEntry | SiteDiaryEntry | JobVariation | RamsDocument | TeamMember | TimesheetEntry | LabourRate | BusinessOverhead | LabourCostSettings | BusinessProfile | VatSettings | BusinessBankDetails | PaymentTermsTemplate | DocumentBrandingSettings | CertificateDefaults | PlannerEntry | FleetVehicle | ToolAsset | BusinessExpense | PricingDocument | Invoice | Material | StockLocation | StockItem | StockMovement | JobPack | PurchaseList | SiteSurvey | ElectricalCertificate | JobDocument;
