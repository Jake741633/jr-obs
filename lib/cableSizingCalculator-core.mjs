 ...
 * @property {number} sizeMm2
 * @property {number} tabulatedCurrentAmps
 */
...
/**
 * @param {{ requiredCurrentAmps?: number, cableOptions?: CableOption[] }} [input]
 */
 ...
 *   ambientTemperatureFactor?: number,
