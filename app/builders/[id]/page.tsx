...
import { ArrowLeft, BriefcaseBusiness, Building2, Mail, MapPin, Phone, User } from "lucide-react";
...
export default function BuilderDetailPage() {
  ...
  if (!builders.isReady || !jobs.isReady) return <Card>Loading builder…</Card>;
