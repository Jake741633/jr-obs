...
- electrician generic field reads use a sanitised projection; surveys and their private photos are limited to assigned jobs; timeline activity is also assignment-scoped; current and legacy site diaries are assignment-scoped too, while survey rates, job-pack prices, variation pricing and material unit costs stay office-only
