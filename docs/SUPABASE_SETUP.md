...
- electrician typed inventory reads remove material trade and sell prices, price-check metadata, stock unit costs and purchase-list item costs; inventory edits preserve hidden office pricing; canonical stock-movement history, including job links, movement notes and timestamps, remains office-only
