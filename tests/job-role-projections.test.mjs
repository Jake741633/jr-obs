...
test("electrician updates preserve hidden office data and cannot rebind customers", () => {
...
test("live RLS runner covers job redaction, tenant scope and safe field updates", () => {
  for (const phrase of [
    ...
    "Field updates must preserve hidden commercial job data",
