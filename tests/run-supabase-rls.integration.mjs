...
const fieldJobCompletionOfficeCoverage = [
  ...
  '    await expectAllowed(await insertRecord(accounts.A.office, "cloud_collections", genericRecord(organisationA, "jr-os-job-completion", assignedCompletionId, accounts.A.office, null, jobA, { ...completionPayload, id: assignedCompletionId, jobId: jobA })), "Office should create assigned completion evidence without a customer envelope");',
  '    await expectAllowed(await insertRecord(accounts.A.office, "cloud_collections", genericRecord(organisationA, "jr-os-job-completion", unassignedCompletionId, accounts.A.office, null, otherCustomerJobA, { ...completionPayload, id: unassignedCompletionId, jobId: otherCustomerJobA, customerSignOffName: "Unassigned Private Customer" })), "Office should create unassigned completion evidence without a customer envelope");',
  '    await expectAllowed(await insertRecord(accounts.B.office, "cloud_collections", genericRecord(organisationB, "jr-os-job-completion", crossTenantCompletionId, accounts.B.office, null, jobB, { ...completionPayload, id: crossTenantCompletionId, jobId: jobB, customerSignOffName: "Other Tenant Customer" })), "Tenant B office should create cross-tenant completion evidence");',
  '    await expectAllowed(await insertRecord(accounts.A.office, "cloud_collections", genericRecord(organisationA, "jr-os-job-completion", unboundCompletionId, accounts.A.office, null, undefined, { ...completionPayload, id: unboundCompletionId, jobId: undefined })), "Office should create wholly unbound completion evidence");',
  ...
  '    await expectAllowed(await insertRecord(accounts.A.office, "cloud_collections", genericRecord(organisationA, "jr-os-job-completion", deletedJobCompletionId, accounts.A.office, null, deletedCompletionJob, { ...completionPayload, id: deletedJobCompletionId, jobId: deletedCompletionJob })), "Office should create completion evidence before job deletion");',
  '',
  ...
  '    const officeAssignedCompletion = await listRecords(accounts.A.office, "cloud_collections", "select=source_id,payload&collection_key=eq.jr-os-job-completion&source_id=eq." + assignedCompletionId);',
