...
const certificateCoverage = [
  ...
  "      \"Electrician should issue a same-tenant certificate\",",
  "    );",
  "",
  ...
  "",
  "    await expectAllowed(",
  "      await patchRecords(accounts.A.electrician, \"certificates\", \"source_id=eq.\" + certificateA, { payload: { ...issuedCertificatePayload, status: \"Superseded\", updatedAt: \"2026-08-10T00:00:00.000Z\" } }),",
  "      \"Electrician should supersede a same-tenant certificate\",",
  "    );",
