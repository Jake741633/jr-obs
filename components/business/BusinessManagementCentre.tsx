...
export function BusinessManagementCentre() {
  ...
  return <div className="space-y-6">
    ...
    <Card className="border-cyan-400/20 bg-cyan-400/5">
      <h2 className="font-bold">Pricing and document defaults</h2>
      <p className="mt-2 text-sm text-slate-400">Labour rates, overheads, travel, parking, mark-up, contingency, document branding and certificate defaults continue in the next sections of this centre.</p>
      <Link href="/labour-costs" className="mt-4 inline-flex min-h-11 items-center rounded-xl border border-slate-700 bg-slate-900 px-4 text-sm font-semibold text-slate-100 hover:bg-slate-800">Open Labour & Costs Centre</Link>
    </Card>
  </div>;
}
