...
export const secondaryNavigation = [
  ["Leads & Pipeline", "/leads"], ["CRM & Customer Care", "/crm"], ["Customer Portal", "/customer-portal"], ["Quotes", "/quotes"], ["Mobile Quick Quotes", "/quotes/mobile"], ["Quote Presentation", "/quotes/presentation"], ["Estimates", "/estimates"], ["Invoices", "/invoices"], ["Payments & Cash Flow", "/payments"], ["AI Finance Director", "/finance-director"], ["Labour & Costs", "/labour-costs"], ["Expenses & Receipts", "/expenses"], ["Job Finance", "/job-finance"], ["Starter Library", "/starter-library"], ["Materials", "/materials"], ["Stock Control", "/stock"], ["Purchase Lists", "/purchases"],
