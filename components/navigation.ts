...
export const secondaryNavigation = [
  ...
  ["Site Management", "/site-management"], ["RAMS & Risk Assessments", "/rams"], ["Test Equipment & Compliance", "/test-equipment"], ["Resource Planner", "/planner"], ["Team & Timesheets", "/team"], ["Fleet & Assets", "/assets"], ["Surveys", "/surveys"], ["Certificates", "/certificates"], ["Job Packs", "/job-packs"], ["JR AI", "/ai"], ["AI Quote Review", "/ai/quote-review"], ["Business", "/business"], ["Cloud & Account", "/cloud"],
] as const;
