...
export const secondaryNavigation = [
  ...
  ["Site Management", "/site-management"], ["Resource Planner", "/planner"], ["Team & Timesheets", "/team"], ["Surveys", "/surveys"], ["Certificates", "/certificates"], ["Job Packs", "/job-packs"], ["JR AI", "/ai"], ["Business", "/business"], ["Cloud & Account", "/cloud"],
] as const;
