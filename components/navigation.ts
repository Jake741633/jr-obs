...
export const secondaryNavigation = [
  ...
  ["Mobile Workspace", "/field"], ["Engineer Day Planner", "/field/day-planner"], ["Mobile Site Diary", "/field/site-diary"], ["Mobile Job Control", "/field/jobs"], ["Mobile Materials", "/field/materials"], ["Mobile Snag Control", "/field/snags"], ["Mobile QA Inspections", "/field/qa"], ["Mobile Testing", "/field/testing"], ["Completion Packs", "/completion-packs"], ["Site Management", "/site-management"], ["RAMS & Risk Assessments", "/rams"], ["Test Equipment & Compliance", "/test-equipment"], ["Resource Planner", "/planner"], ["Team & Timesheets", "/team"], ["Fleet & Assets", "/assets"], ["Surveys", "/surveys"], ["Certificates", "/certificates"], ["Job Packs", "/job-packs"], ["AI Command Centre", "/ai"], ["AI Quote Builder", "/ai/quote-builder"], ["AI Materials Assistant", "/ai/materials"], ["AI Pricing Assistant", "/ai/pricing"], ["AI Business Coach", "/ai/business-coach"], ["AI Daily Briefing", "/ai/daily-briefing"], ["AI Quote Review", "/ai/quote-review"], ["AI Job Review", "/ai/job-review"], ["Business", "/business"], ["Release Readiness", "/release-readiness"], ["Cloud & Account", "/cloud"], ["Cloud Cutover Check", "/cloud/cutover"], ["Sync Queue Diagnostics", "/cloud/queue"],
] as const;
